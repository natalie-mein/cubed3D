...
// char		*get_texture_path(char **trimmed, t_data *data); // STATIC 
//bool		check_duplicated_element(t_data *data, char *trimmed); // STATIC
...
// int			get_colour(char *line, t_data *data);// STATIC
